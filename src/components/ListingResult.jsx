    ...
    return (
        <Row className="ListingResult">
            ...
            <Col sm={6} md={8} className="d-flex flex-column justify-content-between">
                ...
                <span>{listing.guests} guests - {listing.bedrooms} bedrooms - {listing.beds} beds - {listing.bathrooms} bathrooms </span>
                <span className="d-block">{listing.amenities.map((amen,i)=> i < listing.amenities.length - 1 ? `${amen} - ` : `${amen}`)}</span>
                </div>
                <div className="d-flex justify-content-between">
                    <span className="ListingResult__stars d-flex flex-row align-items-end"><StarIcon/>4.8 (83)</span>
                    <div className="ListingResult__rate"><h5>${listing?.rate} / night</h5>
                    ${totRate}/total</div>
