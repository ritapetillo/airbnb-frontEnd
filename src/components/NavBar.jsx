...
console.log(userName)
  ...
  const logo = useMemo(
    () => (history.location.pathname === "/" ? logowhite : logored),
    [history.location.pathname]
  );

  const navbarClass = useMemo(
    () =>
      history.location.pathname === "/" ? "NavBar" : "NavBar NavBar-white",
    [history.location.pathname]
  );
  ...
  const links = useMemo(() => {
    return history.location.pathname === "/search" && !searchActive ? (
      <SmSearchBar
      ...
      <Nav className="ml-auto">
        <Link to="/search">
          <Nav.Link href="#home" className="NavBar__link active">
            Place to stay
          </Nav.Link>
        </Link>
  ...
  return (
    <>
      <Navbar expand="lg" className={navbarClass}>
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav className="ml-auto NavBar__right-menu">
              <Nav.Link className="NavBar__right-menu" href="#link">
                Become a host
              </Nav.Link>
              <NavDropdown
                title={
                  <span className="NavBar__drop-title">
        ...
        {searchActive && (
          <div ref={ref} className="NavBar__search-box d-block ml-auto mx-auto">
            {" "}
